...
func TestMaxBinPower(t *testing.T) {
	...
	for i, x := range cases {
		...
		if res != expected[i] {
			t.Errorf("Got %d -- want %d", res, expected[i])
		}
	}
}
...
func TestBitReverse(t *testing.T) {
	expected := []Bin32u{
		...
		0b1010 << 28, 0b1011 << 28, 0b1111001 << 25, 0b10000000 << 24, 0b11001000 << 24, 0b100000000 << 24, 0b101001101 << 23,
		...
		0b100000000000000000001 << 11, 0b111111111111111111111111111111 << 3,
